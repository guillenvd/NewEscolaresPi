...
$sqlGetprom = "SELECT * FROM alumnos where indice ='".$Indice."'"; //Query para selecionar a todos los alumnos
...
// Verificar el tiempo promedio para el alumno
	...
	$sql = "INSERT INTO alumnos (turno,hora_inicio,estado,ficha_inscripcion,indice,tiempo_estimado, idAspirante) 
	VALUES (".$nuevoTurno.",'".$Date."',1,".$Ficha.",'".$Indice."', ".$promedioTiempo.", ".$idAlumno." );";
	...
	$json = array("key1" => $bandera,"tiempo" =>$promedioTiempo,"turno" =>$nuevoTurno, 'IDALUMNO'=> $idAlumno);
